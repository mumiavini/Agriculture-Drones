...
% ===================================================================
% MARCADORES DE REVISÃO (revisão de maio/2026)
% \citesugerida{texto} -> trecho que PRECISA de uma fonte mas ainda
%                          NÃO existe referência adequada na bibliografia.
%                          Renderiza em itálico. Procure no PDF e busque fonte.
% Para DESLIGAR todos os realces de revisão antes de entregar a versão
% final, basta trocar as duas definições abaixo por: \newcommand{\citesugerida}[1]{#1}
\usepackage{xcolor}
\newcommand{\citesugerida}[1]{{\color{red}\textit{[FALTA FONTE: }#1\textit{]}}}
% ===================================================================
\usepackage{hyperref}
\hypersetup{
    colorlinks=true,
...
\begin{itemize}
    ...
    \item \textbf{Aderência ao mercado brasileiro:} O EMB-202/203 Ipanema (MTOW \SI{1800}{kg}) é a plataforma líder da pulverização aérea brasileira, com cerca de 60\% de participação na frota nacional \cite{embraer_1700}, situando-se exatamente no centro da faixa estudada. % [REVISAO] dado corrigido de ~80% para ~60% (fonte oficial Embraer 2025) e citacao adicionada
...
\begin{itemize}
    ...
    \item \textbf{Mistura de Melhor Economia (\textit{Best Economy}):} Razão ar/combustível próxima à estequiométrica (cerca de 14{,}7:1) ou ligeiramente pobre. Adequada ao cruzeiro e a deslocamentos, reduzindo o consumo específico em até 15\% em relação à mistura de melhor potência \cite{io360manual}. % [REVISAO] citacao adicionada (manual IO-360, mesma curva ja referenciada na secao)
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Aviônica de Cabine:} Os dados de motor, navegação e geo-referenciamento de pulverização podem ser enviados à cabine por meio de Sistemas de Voo Eletrônicos (EFIS), como o Garmin G600 TXi ou o Avidyne IFD-540, e, a partir destes, retransmitidos a uma Estação de Controle em Solo (GCS --- \textit{Ground Control Station}). Entretanto, alguns exemplares de aeronaves clássicas (Pawnee, AgWagon, Ipanema EMB-201) ainda utilizam instrumentação analógica, o que dificulta a integração com sistemas de comunicação modernos e com arquiteturas de operação não tripulada. % [REVISAO] paragrafo reescrito por sintaxe quebrada no original
\end{itemize}
...
\begin{thebibliography}{99}
    ...
    Embraer. \textit{Embraer celebra 1.700 unidades entregues do avião agrícola Ipanema}. Media Center, Botucatu, 19 de novembro de 2025. Versão atual EMB-203, com $\sim$60\% de participação no mercado nacional de pulverização. Disponível em: \url{https://www.embraer.com/media-center/pt/?detail=23507&mediatype=NEWS} % [REVISAO] referencia nova adicionada
    ...
    Sindicato Nacional das Empresas de Aviação Agrícola (SINDAG). \textit{Análise da Frota Aeroagrícola Brasileira de Aviões e Helicópteros 2025}. Autor: Cláudio Júnior Oliveira Gomes. Frota registrada na ANAC: 2.866 aeronaves ao final de 2025 (crescimento de 5,25\% sobre 2024). Acessado em: maio de 2026. % [REVISAO] referencia nova adicionada
